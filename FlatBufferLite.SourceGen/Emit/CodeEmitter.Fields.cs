...
if (f.Type.IsString)
{
_w.Append("public FlatString ").Append(propName).Append(" => new FlatString(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
return;
}
if (f.Type.IsObject)
{
...
if (def is TableDef)
{
_w.Append("public ").Append(name).Append("Ref ").Append(propName).Append(" => new ").Append(name).Append("Ref").Append("(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
return;
}
if (def is StructDef)
{
...
_w.Append("public FlatVector<").Append(cs).Append("> ").Append(propName).Append(" => new FlatVector<").Append(cs).Append(">(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
...
_w.Append("public ").Append(f.NestedFlatBufferType).Append("Ref ").Append(propName).Append("Nested => ").Append(f.NestedFlatBufferType).Append("Ref.GetRootAs(").Append(propName).AppendLine(".AsSpan);");
return;
}
if (elt == SchemaBaseType.String)
{
_w.Append("public FlatStringVector ").Append(propName).Append(" => new FlatStringVector(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
return;
}
...
if (def is StructDef)
{
_w.Append("public FlatVector<").Append(name).Append("> ").Append(propName).Append(" => new FlatVector<").Append(name).Append(">(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
return;
}
if (def is TableDef)
{
_w.Append("public ").Append(name).Append("RefVector ").Append(propName).Append(" => new ").Append(name).Append("RefVector(_buf, Vtable.ReadIndirect(_buf, _pos, ").Append(vto).AppendLine("));");
return;
}
if (def is EnumDef ed)
{
